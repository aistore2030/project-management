...
fbUtils.inArray = function(e, t) {
        ...
        switch (e.type) {
            ...
            case "rich-text":
                delete e.type;
                var p = e.value || "";
                r = a + "<textarea " + u + " disabled='disabled'>" + p + "</textarea>";
                break;
            case "select":
                var d;
                ...
                r = a + "<select " + u + " disabled='disabled'>" + i + "</select>";
                break;
            case "checkbox-group":
            case "radio-group":
                var b = void 0;
                if (e.type = e.type.replace("-group", ""), "checkbox" === e.type && (e.name = e.name + "[]"), c) {
                    for (var v = void 0, y = 0; y < c.length; y++) b = Object.assign({
                        value: "",
                        label: ""
                    }, e, c[y]), b.selected && (delete b.selected, b.checked = null), b.id = e.id + "-" + y, v = fbUtils.attrString(b), i += "<input " + v + ' disabled="disabled" /> <label for="' + b.id + '">' + b.label + "</label><br>";
                    if (e.other) {
                        var h = {
                            id: e.id + "-other",
            ...
            case "tel":
            case "autocomplete":
                r = a + " <input " + u + " disabled='disabled'>";
                break;
            case "color":
                r = a + " <input " + u + " disabled='disabled'> " + t.messages.selectColor;
                break;
            case "button":
            case "submit":
                r = "<button " + u + ">" + f + "</button>";
                break;
            case "checkbox":
                r = "<input " + u + " disabled='disabled'> " + a, e.toggle && setTimeout(function() {
