<div class="cqpim_block">
	<div class="cqpim_block_title">
		<div class="caption">
			<i class="fa fa-life-ring font-green-sharp" aria-hidden="true"></i> <?php _e('Add Support Ticket', 'cqpim'); ?>
		</div>
	</div>
	<?php 
	...
	<div class="cqpim-dash-item-inside">	
		...
		<div id="cqpim_backend_quote">
				...
				<div class="clear"></div>
				<input id="support-submit" type="submit" class="cqpim_button bg-blue font-white rounded_2 mt-20" style="margin-right:0" value="<?php _e('Create Ticket', 'cqpim'); ?>" />
			<br />
		</div>
	</div>
</div>	