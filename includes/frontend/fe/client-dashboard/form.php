<div class="cqpim_block">
	<div class="cqpim_block_title">
		<div class="caption">
			<i class="fa fa-envelope font-green-sharp" aria-hidden="true"></i> <?php _e('Request a Quote', 'cqpim'); ?>
		</div>
	</div>
	<div class="cqpim-dash-item-inside">
		...
		<div class="cqpim-dash-item-inside">
			...
			if(!empty($fields)) {
				...
				echo '<br />';
				echo '<input type="submit" class="cqpim_button bg-blue font-white rounded_2" id="cqpim_submit_backend" value="' . __('Submit Quote Request', 'cqpim') . '" /><br /><div id="form_spinner" style="clear:both; display:none; background:url(' . PTO_PATH . 'includes/css/img/ajax-loader.gif) center center no-repeat; width:16px; height:16px; padding:10px 0 0 5px; margin-top:15px"></div>';
		...
		<?php echo '<input type="hidden" id="client" value="' . $assigned . '" />'; ?>
