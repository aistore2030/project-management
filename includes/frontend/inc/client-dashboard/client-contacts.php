	...
	<div class="cqpim_block_title">
		<div class="caption">
			...
			<span class="caption-subject font-green-sharp sbold"> <?php _e('Contacts', 'cqpim'); ?></span>
		</div>
	</div>
	<?php 
	...
	if($client_settings == 1) { ?>
		...
		<br /><br />
		<a id="add_client_team" class="cqpim_button font-white bg-blue rounded_2 op"><?php _e('Add Contact', 'cqpim'); ?></a>
	<?php } ?>
	<div class="clear"></div>
	<div id="add_client_team_ajax_container" style="display:none">
		<div id="add_client_team_ajax">
			<div style="padding:12px">
				...
				<button class="cancel-colorbox cqpim_button font-red border-red op mt-20"><?php _e('Cancel', 'cqpim'); ?></button>
				<button id="add_client_team_submit" class="cqpim_button mt-20 font-green border-green right op"><?php _e('Add Client Contact', 'cqpim'); ?><span id="ajax_spinner_add_contact" class="ajax_loader" style="display:none"></span></button>
			</div>
		</div>
	</div>
	</div>