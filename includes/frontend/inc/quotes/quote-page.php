<div id="cqpim-dash-content">
	<div id="cqpim_admin_title">
		<?php $title = get_the_title(); $title = str_replace('Private:', '', $title); echo '<a href="' . get_the_permalink($client_dash) . '">' . __('Dashboard', 'cqpim') . '</a> <i class="fa fa-circle"></i> <a href="' . get_the_permalink($client_dash) . '?page=quotes">' . __('Quotes / Estimates', 'cqpim') . '</a> <i class="fa fa-circle"></i> ' . $title; ?>							
	</div>
