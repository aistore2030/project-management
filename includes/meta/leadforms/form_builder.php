...
function pto_leadform_builder_builder_metabox_callback( $post ) {
 	wp_nonce_field( 
	'leadform_builder_builder_metabox', 
	'leadform_builder_builder_metabox_nonce' );
...
add_action( 'save_post', 'save_pto_leadform_builder_builder_metabox_data' );
function save_pto_leadform_builder_builder_metabox_data( $post_id ){
	if ( ! isset( $_POST['leadform_builder_builder_metabox_nonce'] ) )
	    return $post_id;
	$nonce = $_POST['leadform_builder_builder_metabox_nonce'];
